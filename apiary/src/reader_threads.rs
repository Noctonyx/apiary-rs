...
impl ParallelChunkSizes {
    pub fn extract_chunk_size(self, num: usize) -> Self {
        Self {
    ...
    pub fn extract_per_view_chunk_size(self, num: usize) -> Self {
        Self {
    ...
    pub fn prepare_chunk_size(self, num: usize) -> Self {
        Self {
    ...
    pub fn prepare_per_view_chunk_size(self, num: usize) -> Self {
        Self {
...
impl ApiaryRendererThreadPool {
    fn extract_render_object_instance_num_chunks<'extract>(
        &self,
    ...
    fn extract_render_object_instance_per_view_num_chunks<'extract>(
        &self,
        extract_job: &Arc<dyn RenderFeatureExtractJob<'extract> + 'extract>,
    ...
    fn prepare_render_object_instance_num_chunks<'prepare>(
        &self,
    ...
    fn prepare_render_object_instance_per_view_num_chunks<'prepare>(
        &self,
        prepare_job: &Arc<dyn RenderFeaturePrepareJob<'prepare> + 'prepare>,
        view_packet: &dyn RenderFeatureViewPacket,
    ) -> Option<(usize, usize)> {
...
impl RendererThreadPool for ApiaryRendererThreadPool {
